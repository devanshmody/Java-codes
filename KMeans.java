...
public class KMeans {
    ...
    private static double findEuclideanDistance(Point2D.Double a, Point2D.Double b){
        return Math.sqrt(
    ...
    private static Point2D.Double findMean(Point2D.Double a, Point2D.Double b) {
        double meanX = (a.getX() + b.getX())/2;
        double meanY = (a.getY()+ b.getY())/2;
